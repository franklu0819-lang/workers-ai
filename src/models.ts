...
const MODEL_ENTRIES: readonly ModelEntry[] = [
  // Chat models
  { alias: "llama-8b-fast", id: "@cf/meta/llama-3.1-8b-instruct-fast", type: "chat" },
  { alias: "llama-8b", id: "@cf/meta/llama-3.1-8b-instruct", type: "chat" },
  { alias: "llama-70b", id: "@cf/meta/llama-3.3-70b-instruct-fp8-fast", type: "chat" },
  { alias: "llama-4-scout", id: "@cf/meta/llama-4-scout-17b-16e-instruct", type: "chat" },
  { alias: "llama-3b", id: "@cf/meta/llama-3.2-3b-instruct", type: "chat" },
  { alias: "llama-1b", id: "@cf/meta/llama-3.2-1b-instruct", type: "chat" },
  { alias: "deepseek-r1-32b", id: "@cf/deepseek-ai/deepseek-r1-distill-qwen-32b", type: "chat" },
  { alias: "qwen3-30b", id: "@cf/qwen/qwen3-30b-a3b-fp8", type: "chat" },
  { alias: "qwq-32b", id: "@cf/qwen/qwq-32b", type: "chat" },
  { alias: "qwen-coder", id: "@cf/qwen/qwen2.5-coder-32b-instruct", type: "chat" },
  { alias: "gemma-3-12b", id: "@cf/google/gemma-3-12b-it", type: "chat" },
  { alias: "gemma-4-26b", id: "@cf/google/gemma-4-26b-a4b-it", type: "chat" },
